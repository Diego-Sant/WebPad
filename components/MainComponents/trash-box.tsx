    ...
    return (
        <div className="text-sm">
            <div className="flex items-center gap-x-1 p-2">
                ...
                <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Procurar título do bloco de notas..." className="h-7 px-2 focus-visible:ring-transparent bg-secondary"/>
            </div>
            <div className="mt-2 px-1 pb-1">
                <p className="hidden last:block text-xs text-center text-muted-foreground pb-2">
                    Sem bloco de notas na lixeira.
                </p>
